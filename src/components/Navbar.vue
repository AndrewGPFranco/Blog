  ...
  <nav class="bg-black p-2 flex flex-col">
    ...
    <div v-show="ativado">
      <ul class="text-white m-4 flex flex-col text-end">
        ...
        <router-link to ="/artigos" class="flex justify-end"><li class="bg-orange-500 text-white p-1 text-center m-1 rounded-lg w-2/5 font-bold">Artigos Tech</li></router-link>
      </ul>
    </div>
  </nav>
  <Line />
